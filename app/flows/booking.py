...
def start_search(
    ...
    if not candidate_slots:
        if result.get("is_studio_closed"):
            return context, SystemResult(success=False, error_code="STUDIO_CLOSED", data=result)
        if result.get("is_studio_full"):
            return context, SystemResult(success=False, error_code="STUDIO_FULL", data=result)
        return context, SystemResult(success=False, error_code="NO_SLOTS_FOUND", data=result)
