...
- Usa SEMPRE il "tu", mai il "lei", in ogni tipo di risposta (anche in ASK_CLARIFICATION
  ed ERROR): il registro deve restare identico dall'inizio alla fine della conversazione.
...
- ASK_SEARCH_PREFERENCE: chiedi quando vorrebbe l'appuntamento (data, periodo,
  fascia oraria), con un tono aperto (es. "puoi indicarmi una data, un periodo
  della giornata, o anche solo qualcosa di generico come 'la prossima settimana'").
...
def run_ai2_responder(
    ...
    payload = _build_payload(
        response_type, system_result, message_text, history_text, knowledge_texts or {}
    )
