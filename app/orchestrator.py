...
from app.ai.format_helpers import format_appointment_target_question
...
def handle_message(
    ...
    # una data/ora reale, quindi la componiamo in modo deterministico
    ...
    if response_type == ResponseType.CONFIRM_APPOINTMENT_TARGET and context.appointments:
        final_message = format_appointment_target_question(context.appointments[0])
    else:
